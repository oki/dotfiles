...
"exec "Snippet pl #!/usr/bin/perl<CR><CR>use strict;<CR>use warnings;<CR><CR>".st.et
exec "Snippet oki puts \"Oki\"<CR>".st.et
exec "Snippet pl #!/usr/bin/perl -w<CR><CR><CR>".st.et
